 ...
 */
public class UsageAuthRateCharge3IT_pt1 {
...
// java.lang.Character
        ...
        softly.assertThat(usageAuth.getPackage().getNotificationCategory() ).as(" usageAuth.getPackage().getNotificationCategory()" ).isEqualTo("");
// com.vizzavi.ecommerce.business.catalog.PaymentContent
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getDescription() ).as(" usageAuth.getPackage().getPaymentContent().getDescription()" ).isNullOrEmpty();
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getCategory() ).as(" usageAuth.getPackage().getPaymentContent().getCategory()" ).isNullOrEmpty();
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getMerchant() ).as(" usageAuth.getPackage().getPaymentContent().getMerchant()" ).isNullOrEmpty();
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getMerchantDescription() ).as(" usageAuth.getPackage().getPaymentContent().getMerchantDescription()" ).isNullOrEmpty();
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getItemVolume() ).as(" usageAuth.getPackage().getPaymentContent().getItemVolume()" ).isNullOrEmpty();
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getServiceType() ).as(" usageAuth.getPackage().getPaymentContent().getServiceType()" ).isNullOrEmpty();
        ...
        softly.assertThat(usageAuth.getPackage().getPaymentContent().getPromotion() ).as(" usageAuth.getPackage().getPaymentContent().getPromotion()" ).isNullOrEmpty();
...
// java.util.Date
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getTime() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getTime()" ).isEqualTo(new Long(978307200000L)) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getYear() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getYear()" ).isEqualTo(101) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getMonth() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getMonth()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getDate() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getDate()" ).isEqualTo(1) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getHours() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getHours()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getMinutes() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getMinutes()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getSeconds() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getSeconds()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getDay() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getDay()" ).isEqualTo(1) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getStartDate().getTimezoneOffset() ).as(" usageAuth.getPackage().getPricePoints().get(0).getStartDate().getTimezoneOffset()" ).isEqualTo(0) ;
...
// java.util.Date
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getTime() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getTime()" ).isEqualTo(new Long(1609372800000L)) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getYear() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getYear()" ).isEqualTo(120) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getMonth() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getMonth()" ).isEqualTo(11) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getDate() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getDate()" ).isEqualTo(31) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getHours() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getHours()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getMinutes() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getMinutes()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getSeconds() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getSeconds()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getDay() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getDay()" ).isEqualTo(4) ;
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getTimezoneOffset() ).as(" usageAuth.getPackage().getPricePoints().get(0).getExpiryDate().getTimezoneOffset()" ).isEqualTo(0) ;
...
//if the list is smaller than expected we can't continue, so do a hard assert
        ...
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(0).getTax().getTaxRates().get(0).getValue() ).as(" usageAuth.getPackage().getPricePoints().get(0).getTax().getTaxRates().get(0).getValue()" ).isEqualTo(new Double(0.175)) ;
...
//if the list is smaller than expected we can't continue, so do a hard assert
        ...
        softly.assertThat(usageAuth.getPackage().getPricePoints().get(1).getTax().getTaxRates().get(0).getValue() ).as(" usageAuth.getPackage().getPricePoints().get(1).getTax().getTaxRates().get(0).getValue()" ).isEqualTo(new Double(0.175)) ;
