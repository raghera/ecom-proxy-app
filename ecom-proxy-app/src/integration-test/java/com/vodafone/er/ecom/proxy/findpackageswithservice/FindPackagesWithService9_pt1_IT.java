 ...
 */
public class FindPackagesWithService9_pt1_IT {
    ...
    public void findPackagesWithService9() throws Exception {
        ...
        for(CatalogPackage p : packages) {
            if(p.getFullPackagePricepointId().equals("pAlt__X__package:pAlt_TAX_3_2_999_999_999_*_*")) {
                pack = p;
                break;
            }
        }
...
// java.util.HashMap
        ...
        softly.assertThat(pack.getPricePoint().getPricingText1() ).as(" pack.getPricePoint().getPricingText1()" ).isEqualTo("");
        softly.assertThat(pack.getPricePoint().getPricingText2() ).as(" pack.getPricePoint().getPricingText2()" ).isNullOrEmpty();
        softly.assertThat(pack.getPricePoint().getPricingText2() ).as(" pack.getPricePoint().getPricingText2()" ).isEqualTo("");
// java.util.HashMap
// java.util.HashMap
...
// com.vizzavi.ecommerce.business.common.ChargingResource
        ...
        softly.assertThat(pack.getPricePoint().getGlid() ).as(" pack.getPricePoint().getGlid()" ).isEqualTo("");
        ...
        softly.assertThat(pack.getPricePoint().getDiscountPromoText() ).as(" pack.getPricePoint().getDiscountPromoText()" ).isEqualTo("");
...
//if the list is smaller than expected we can't continue, so do a hard assert
        ...
        softly.assertThat(pack.getPricePoint().getmPricingText1() ).as(" pack.getPricePoint().getmPricingText1()" ).isEqualTo("");
        softly.assertThat(pack.getPricePoint().getmPricingText2() ).as(" pack.getPricePoint().getmPricingText2()" ).isEqualTo("");
...
//        softly.assertThat(pack.getServices().get(0).getPricePoints().get(0).getTax().getTaxRates().get(0).value() ).as(" pack.getServices().get(0).getPricePoints().get(0).getTax().getTaxRates().get(0).value()" ).isEqualTo(new Double(0.175)) ;
...
//        softly.assertThat(pack.getServices().get(0).getPricePoints().get(0).getTax().getTaxRates().get(1).value() ).as(" pack.getServices().get(0).getPricePoints().get(0).getTax().getTaxRates().get(1).value()" ).isEqualTo(new Double(0.175)) ;
...
//        softly.assertThat(pack.getServices().get(0).getPricePoints().get(0).getTax().getTaxRates().get(2).value() ).as(" pack.getServices().get(0).getPricePoints().get(0).getTax().getTaxRates().get(2).value()" ).isEqualTo(new Double(0.175)) ;
...
// java.util.HashMap
        ...
        softly.assertThat(pack.getServices().get(0).getPricePoints().get(0).getPricingText1() ).as(" pack.getServices().get(0).getPricePoints().get(0).getPricingText1()" ).isEqualTo("");
        ...
        softly.assertThat(pack.getServices().get(0).getPricePoints().get(0).getPricingText2() ).as(" pack.getServices().get(0).getPricePoints().get(0).getPricingText2()" ).isEqualTo("");
// java.util.HashMap
// java.util.HashMap
...
// java.util.HashMap
        softly.assertThat(pack.getServices().get(0).getPricePoints().get(1).getPricingText1() ).as(" pack.getServices().get(0).getPricePoints().get(1).getPricingText1()" ).isEqualTo("");
        softly.assertThat(pack.getServices().get(0).getPricePoints().get(1).getPricingText2() ).as(" pack.getServices().get(0).getPricePoints().get(1).getPricingText2()" ).isEqualTo("");
// java.util.HashMap
// java.util.HashMap
...
// com.vizzavi.ecommerce.business.common.ChargingResource
        ...
        softly.assertThat(pack.getServices().get(0).getPricePoints().get(1).getTranslatedPricingText() ).as(" pack.getServices().get(0).getPricePoints().get(1).getTranslatedPricingText()" ).isNullOrEmpty();
...
//        softly.assertThat(pack.getServices().get(0).getPaymentContent().getDescription() ).as(" pack.getServices().get(0).getPaymentContent().getDescription()" ).isEqualTo("");
//        softly.assertThat(pack.getServices().get(0).getPaymentContent().getServiceType() ).as(" pack.getServices().get(0).getPaymentContent().getServiceType()" ).isEqualTo("");
//        softly.assertThat(pack.getServices().get(0).getPaymentContent().getCategory() ).as(" pack.getServices().get(0).getPaymentContent().getCategory()" ).isEqualTo("");
//        softly.assertThat(pack.getServices().get(0).getPaymentContent().getMerchant() ).as(" pack.getServices().get(0).getPaymentContent().getMerchant()" ).isEqualTo("");
//        softly.assertThat(pack.getServices().get(0).getPaymentContent().getMerchantDescription() ).as(" pack.getServices().get(0).getPaymentContent().getMerchantDescription()" ).isEqualTo("");
//        softly.assertThat(pack.getServices().get(0).getPaymentContent().getItemVolume() ).as(" pack.getServices().get(0).getPaymentContent().getItemVolume()" ).isEqualTo("");
