...
//        softly.assertThat(subscription1.isNew() ).as(" subscription1.isNew()" ).isFalse() ;
//        softly.assertThat(subscription1.isDirty() ).as(" subscription1.isDirty()" ).isFalse() ;
//        softly.assertThat(subscription1.getPurchasedServices()[0].isNew() ).as(" subscription1.getPurchasedServices()[0].isNew()" ).isFalse() ;
//        softly.assertThat(subscription1.getPurchasedServices()[0].isDirty() ).as(" subscription1.getPurchasedServices()[0].isDirty()" ).isFalse() ;
...
//        softly.assertThat(subscription2.isNew() ).as(" subscription2.isNew()" ).isFalse() ;
//        softly.assertThat(subscription2.isDirty() ).as(" subscription2.isDirty()" ).isFalse() ;
//        softly.assertThat(subscription2.getPurchasedServices()[0].isNew() ).as(" subscription2.getPurchasedServices()[0].isNew()" ).isFalse() ;
//        softly.assertThat(subscription2.getPurchasedServices()[0].isDirty() ).as(" subscription2.getPurchasedServices()[0].isDirty()" ).isFalse() ;
...
//        softly.assertThat(subscription2.getResourceBalances()[0].getId() ).as(" subscription2.getResourceBalances()[0].getId()" ).isEqualTo(new Long(13)) ;
//        softly.assertThat(subscription2.getResourceBalances()[0].isNew() ).as(" subscription2.getResourceBalances()[0].isNew()" ).isFalse() ;
//        softly.assertThat(subscription2.getResourceBalances()[0].isDirty() ).as(" subscription2.getResourceBalances()[0].isDirty()" ).isFalse() ;
//        softly.assertThat(subscription2.getResourceBalances()[0].getLockId() ).as(" subscription2.getResourceBalances()[0].getLockId()" ).isEqualTo(new Long(-1)) ;
//// com.vizzavi.ecommerce.business.common.ChargingResource
...
//        softly.assertThat(subscription2.getOptions() ).as(" subscription2.getOptions()" ).isNull();
...
//        softly.assertThat(subscription2.getResourceBalancesList().get(0).getId() ).as(" subscription2.getResourceBalancesList().get(0).getId()" ).isEqualTo(new Long(13)) ;
//        softly.assertThat(subscription2.getResourceBalancesList().get(0).isNew() ).as(" subscription2.getResourceBalancesList().get(0).isNew()" ).isFalse() ;
//        softly.assertThat(subscription2.getResourceBalancesList().get(0).isDirty() ).as(" subscription2.getResourceBalancesList().get(0).isDirty()" ).isFalse() ;
//        softly.assertThat(subscription2.getResourceBalancesList().get(0).getLockId() ).as(" subscription2.getResourceBalancesList().get(0).getLockId()" ).isEqualTo(new Long(-1)) ;
//// com.vizzavi.ecommerce.business.common.ChargingResource
