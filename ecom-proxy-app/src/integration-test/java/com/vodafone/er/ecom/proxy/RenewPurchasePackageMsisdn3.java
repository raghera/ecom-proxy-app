 ...
 */
public class RenewPurchasePackageMsisdn3 {
...
//// java.util.HashMap
//        softly.assertThat(result.getPackage().getPricePoint().getPricepointIdLink() ).as(" result.getPackage().getPricePoint().getPricepointIdLink()" ).isNull();
//        softly.assertThat(result.getPackage().getPricePoint().isPreview() ).as(" result.getPackage().getPricePoint().isPreview()" ).isFalse() ;
//        softly.assertThat(result.getPackage().getPricePoint().getInteractiveFlag() ).as(" result.getPackage().getPricePoint().getInteractiveFlag()" ).isNull();
...
//// java.util.HashMap
//        softly.assertThat(result.getPackage().getPartnerInfo() ).as(" result.getPackage().getPartnerInfo()" ).isNull();
...
//        softly.assertThat(result.getPackage().getKpiPackageProductCategory() ).as(" result.getPackage().getKpiPackageProductCategory()" ).isNull();
//        softly.assertThat(result.getPackage().getKpiPackageType() ).as(" result.getPackage().getKpiPackageType()" ).isNull();
////check size of array!
...
//// java.util.HashMap
//        softly.assertThat(result.getPackage().getLogoId() ).as(" result.getPackage().getLogoId()" ).isNull();
...
//        softly.assertThat(result.getPackage().getDisallowDuplicateSubPurchase() ).as(" result.getPackage().getDisallowDuplicateSubPurchase()" ).isNull();
...
//        softly.assertThat(result.getPackage().getRateCardServiceId() ).as(" result.getPackage().getRateCardServiceId()" ).isNull();
...
// java.util.HashMap
        ...
        softly.assertThat(result.getPricePoint().getInteractiveFlag() ).as(" result.getPricePoint().getInteractiveFlag()" ).isNull();
