 ...
 */
public class GetSubscription26_IT_pt4 {
...
//if the list is smaller than expected we can't continue, so do a hard assert
        ...
        softly.assertThat(usageAuth.getResourceBalancesList().get(0).getId() ).as(" usageAuth.getResourceBalancesList().get(0).getId()" ).isEqualTo(new Long(413)) ;
        softly.assertThat(usageAuth.getResourceBalancesList().get(0).getLockId() ).as(" usageAuth.getResourceBalancesList().get(0).getLockId()" ).isEqualTo(new Long(-1)) ;
// com.vizzavi.ecommerce.business.common.ChargingResource
...
// com.vodafone.global.er.subscriptionmanagement.ERRatingAttributes
        softly.assertThat(usageAuth.getRatingAttributes().getId() ).as(" usageAuth.getRatingAttributes().getId()" ).isEqualTo(new Long(945)) ;
        softly.assertThat(usageAuth.getRatingAttributes().getLockId() ).as(" usageAuth.getRatingAttributes().getLockId()" ).isEqualTo(new Long(0)) ;
...
//if the list is smaller than expected we can't continue, so do a hard assert
        ...
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(0).getValue() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(0).getValue()" ).isEqualTo(new Double(0.175)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(0).getKey() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(0).getKey()" ).isEqualTo(new Long(0)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(1).getValue() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(1).getValue()" ).isEqualTo(new Double(0.175)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(1).getKey() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(1).getKey()" ).isEqualTo(new Long(0)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(2).getValue() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(2).getValue()" ).isEqualTo(new Double(0.175)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(2).getKey() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getTax().getTaxRates().get(2).getKey()" ).isEqualTo(new Long(0)) ;
//check size of array!
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances().length ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances().length" ).isEqualTo(2) ;
// com.vizzavi.ecommerce.business.common.ChargingResource
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getName() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getName()" ).isEqualTo("GBP");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getCode() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getCode()" ).isEqualTo(826) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getDescription() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getDescription()" ).isEqualTo("British Pound Sterling");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getCountryId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getCountryId()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getResourceName() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getResourceName()" ).isEqualTo("ChargingResource_826");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isUsageToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isUsageToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isPayToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isPayToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getResourceSymbol() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().getResourceSymbol()" ).isEqualTo("ChargingResource_Symbol_826");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isCurrency() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isCurrency()" ).isTrue() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isResource() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getResource().isResource()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getSubscription() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getSubscription()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getSubscriptionId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getSubscriptionId()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getThreshold() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getThreshold()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getSubscriptionIdLong() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getSubscriptionIdLong()" ).isEqualTo(new Long(-1)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getOldestSubscriptionId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getOldestSubscriptionId()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getBalance() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getBalance()" ).isEqualTo(new Double(10.0)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getPackageId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getBalances()[0].getPackageId()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().isRecurring() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().isRecurring()" ).isTrue() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getRenewalsUntilLinkedPricepoint() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getRenewalsUntilLinkedPricepoint()" ).isEqualTo(-1) ;
// com.vizzavi.ecommerce.business.catalog.internal.PricePointTier
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getKey() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getKey()" ).isNull();
//check size of list!
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().size()).as("usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().size()").isEqualTo(2);
//if the list is smaller than expected we can't continue, so do a hard assert
        assertTrue(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().size() >= 2);
// com.vizzavi.ecommerce.business.common.ChargingResource
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getName() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getName()" ).isEqualTo("GBP");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getCode() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getCode()" ).isEqualTo(826) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getDescription() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getDescription()" ).isEqualTo("British Pound Sterling");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getCountryId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getCountryId()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getResourceName() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getResourceName()" ).isEqualTo("ChargingResource_826");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isUsageToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isUsageToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isPayToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isPayToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getResourceSymbol() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().getResourceSymbol()" ).isEqualTo("ChargingResource_Symbol_826");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isCurrency() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isCurrency()" ).isTrue() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isResource() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getResource().isResource()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getKey() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getKey()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getId()" ).isEqualTo("826");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getType() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getType()" ).isEqualTo("CREDIT");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getPriceChangeStartDate() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getPriceChangeStartDate()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getFixedAmount() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getFixedAmount()" ).isEqualTo(new Double(10.0)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getScaledAmount() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getScaledAmount()" ).isEqualTo(new Double(0.0)) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getPricePoint() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getPricePoint()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).isCurrency() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).isCurrency()" ).isTrue() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).isResource() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).isResource()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getNotificationThreshold() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getNotificationThreshold()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getRate() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(0).getRate()" ).isEqualTo(new Double(10.0)) ;
// com.vizzavi.ecommerce.business.common.ChargingResource
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getName() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getName()" ).isEqualTo("Content Credit");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getCode() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getCode()" ).isEqualTo(1100035) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getDescription() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getDescription()" ).isNull();
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getCountryId() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getCountryId()" ).isEqualTo(0) ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getResourceName() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().getResourceName()" ).isEqualTo("ChargingResource_1100035");
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().isToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().isToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().isUsageToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().isUsageToken()" ).isFalse() ;
        softly.assertThat(usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().isPayToken() ).as(" usageAuth.getTransactions().get(0).getSubscription().getPackage().getPricePoint().getPricePointTier().getBalanceImpacts().get(1).getResource().isPayToken()" ).isFalse() ;
